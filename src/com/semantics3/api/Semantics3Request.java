...
public class Semantics3Request{
	...
	public Semantics3Request add(String endpoint, Object... fields) throws JSONException {
	...
	public void remove(String endpoint, String... fields) throws JSONException {
		_remove(this.query.get(endpoint),0,fields);
	}
	
	private void _remove(JSONObject subquery,int i, String[] fields) throws JSONException {
	...
	public Semantics3Request field(Object...fields) throws JSONException {
	...
	public JSONObject get() throws OAuthMessageSignerException, OAuthExpectationFailedException, OAuthCommunicationException, IOException, JSONException {
